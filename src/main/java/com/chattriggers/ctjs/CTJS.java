...
public class CTJS implements IAddon {
    @Getter
    ...
    public void onLoad() {
        File pictures = new File("./ChatTriggers/images/");
        pictures.mkdirs();
        assetsDir = pictures;
        new Console();
    ...
    private void registerListeners() {
        EventBus.INSTANCE.register(new WorldListener());
        EventBus.INSTANCE.register(new ClientListener());
    }

    private void registerHooks() {
        Hyperium.INSTANCE.getHandlers().getHyperiumCommandHandler().registerCommand(new CTCommand());
    }
